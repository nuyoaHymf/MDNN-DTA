...
class CreateDatasetInfer(InMemoryDataset):
    def __init__(self, root='/', dataset='kiba', drugList=None, protkey=None, y=None,
        ...
        self.root = root
        self.process(drugList=drugList, protkey=protkey, y=y, smile_graph=smile_graph)
    ...
    def process(self, drugList, protkey, y, smile_graph):
        ...
        for i in range(data_len):
            ...
            # p_size, prot_feature = protein_graph[protein]
            ...
            # GCNData_prot = DATA.Data(x=torch.LongTensor(prot_feature), 
            #                     y=torch.FloatTensor([label])
            #                     )
